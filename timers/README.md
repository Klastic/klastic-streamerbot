...
Recurring actions that fire on a schedule during a live stream. Each timer is a C# inline script that runs on a repeating interval configured in Streamer.bot's Timer settings.

| Timer | File | Description |
|---|---|---|
